...
var DangerousInBrowserAdapter = class {
  ...
  async *run({ messages, abortSignal, context }) {
    ...
    const stream = res.pipeThrough((0, import_toolResultStream.toolResultStream)(context.tools, abortSignal)).pipeThrough((0, import_runResultStream.runResultStream)());
