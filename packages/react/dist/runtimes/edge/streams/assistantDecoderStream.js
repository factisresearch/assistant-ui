...
function assistantDecoderStream() {
  ...
  return new TransformStream({
    transform({ type, value }, controller) {
      if (type !== import_AssistantStreamChunkType.AssistantStreamChunkType.ToolCall && type !== import_AssistantStreamChunkType.AssistantStreamChunkType.ToolCallDelta && type !== import_AssistantStreamChunkType.AssistantStreamChunkType.Error) {
      ...
      switch (type) {
        ...
        case import_AssistantStreamChunkType.AssistantStreamChunkType.FinishMessage: {
          controller.enqueue({
            type: "finish",
            ...value
          });
        ...
        case import_AssistantStreamChunkType.AssistantStreamChunkType.FinishStep: {
          controller.enqueue({
            type: "step-finish",
            ...value
          });
        ...
        case import_AssistantStreamChunkType.AssistantStreamChunkType.Data:
          ...
          break;
        case import_AssistantStreamChunkType.AssistantStreamChunkType.Source:
          controller.enqueue({
            type: "source",
            source: value
          });
          break;
        // TODO
        case import_AssistantStreamChunkType.AssistantStreamChunkType.ReasoningDelta:
        case import_AssistantStreamChunkType.AssistantStreamChunkType.StartStep:
          break;
        default: {
