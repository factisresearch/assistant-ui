import type { MessageStatus, ReasoningContentPart, RunConfig, SourceContentPart, TextContentPart, ThreadAssistantContentPart, ThreadMessage, ThreadStep, ToolCallContentPart } from "../../types/AssistantTypes";
...
export type CoreChatModelRunResult = Omit<ChatModelRunResult, "content"> & {
    readonly content: readonly (TextContentPart | ReasoningContentPart | ToolCallContentPart | SourceContentPart)[];
};
